  ...
  return (
    <View style={styles.screen}>
      <View style={styles.winContainer}>
        <Image source={kamuKalah} style={styles.winImage} />
      </View>
      <View style={styles.thumbsContainer}>
        <Image source={thumbsDown} style={styles.thumbsImage} />
      </View>
      <View style={styles.buttonContainer}>
        <TouchableOpacity onPress={goToHome}>
          <Image source={home_btn} style={styles.button} />
        </TouchableOpacity>
        <TouchableOpacity onPress={handleRedo}>
          <Image source={redo_btn} style={styles.button} />
        </TouchableOpacity>
      </View>
    </View>
  );
