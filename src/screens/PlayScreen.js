    ...
    <View style={styles.screen}>
      ...
      <View style={styles.scoreContainer}>
        <View style={styles.scoreBox}>
          ...
          <Text style={styles.scoreLeft}>{username}</Text>
        </View>
        <View style={styles.scoreBox}>
      ...
      <View style={styles.rpsPick}>
        <TouchableOpacity
          style={styles.rpsPickCont}
          onPress={() => handleChoice("rock")}
        >
          <Image source={rock} style={styles.rpsImg} resizeMode="contain" />
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.rpsPickCont}
          onPress={() => handleChoice("scissors")}
        >
          <Image source={scissors} style={styles.rpsImg} resizeMode="contain" />
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.rpsPickCont}
          onPress={() => handleChoice("paper")}
        >
          <Image source={paper} style={styles.rpsImg} resizeMode="contain" />
        </TouchableOpacity>
      </View>
    </View>
  );
